...
Skupna cena: ${(totalsNakup as any).totalPrice?.toFixed(2)} €`;
  ...
  const generateNajemTable = useCallback(() => {
    ...
    itemsToUse.forEach(item => {
      ...
      const itemFreqText = itemFreq === '1' ? '1 teden' : `${itemFreq} tedne`;
...
Cena: ${totals.totalPrice.toFixed(2)} €`;
  ...
  const generateNakupTableHTML = useCallback(() => {
    ...
    const rows = offerItemsNakup.map(item =>
      `<tr><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml(item.pricePerUnit.toFixed(2))} €</td></tr>`
    ).join('');
  ...
  const generateNajemTableHTML = useCallback(() => {
    ...
    const rows = itemsToUse.map(item => {
      if (item.seasonal && item.seasonalFromWeek && item.seasonalToWeek && item.seasonalPrice) {
        ...
        return `<tr><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${normalFreqText}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${normalPeriod}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml(normalPrice.toFixed(2))} €</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr><tr style="background-color: #fff8e6;"><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;"><strong>${seasonalFreqText}</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;"><strong>${seasonalPeriod}</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;"><strong>${escapeHtml(item.seasonalPrice.toFixed(2))} €</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr>`;
      }
      const itemFreq = item.frequencyOverride || offerFrequency;
      const itemFreqText = itemFreq === '1' ? '1 teden' : `${itemFreq} tedna`;
      const isOverride = !!item.frequencyOverride && item.frequencyOverride !== offerFrequency;
      return `<tr><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;${isOverride ? ' font-weight: bold;' : ''}">${itemFreqText}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">-</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml(item.pricePerUnit.toFixed(2))} €</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr>`;
    }).join('');
  ...
  const generateSingleItemTableHTML = useCallback((item: OfferItem) => {
    const itemFreq = item.frequencyOverride || offerFrequency;
    const frequencyText = itemFreq === '1' ? '1 teden' : `${itemFreq} tedna`;
    ...
    if (isSeasonal) {
      ...
      rows = `<tr><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${normalFreqText}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${normalPeriod}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml(normalPrice.toFixed(2))} €</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr><tr style="background-color: #fff8e6;"><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;"><strong>${seasonalFreqText}</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;"><strong>${seasonalPeriod}</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;"><strong>${escapeHtml(item.seasonalPrice!.toFixed(2))} €</strong></td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr>`;
    ...
    rows = `<tr><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.code || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.name)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.size || '')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${escapeHtml(item.customized ? 'da' : 'ne')}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: center;">${escapeHtml(item.quantity)}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px;">${frequencyText}</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml(item.pricePerUnit.toFixed(2))} €</td><td style="border: 1px solid ${tableStyles.border}; padding: 8px; text-align: right;">${escapeHtml((item.replacementCost || 0).toFixed(2))} €</td></tr>`;
